...
from train.train import sigmoid, aa_train, eval
...
def main():
    ...
    for seed in range(args.num_runs):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            aa_train(model, device, train_loader, criterion, optimizer, step_size = args.step_size, max_pert = args.max_pert, m = args.m)
